...
export default function FarmerAgriWaste() {
    ...
    const fetchBids = async () => {
        try {
            const res = await axios.get(`${API_URL}/products/my?isAgriWaste=true`);
    ...
    if (loading) {
        return (
            <View style={styles.center}>
                ...
                <Text style={styles.loadingText}>Fetching Agri Waste listings...</Text>
            </View>
        );
    }
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        <MaterialCommunityIcons name="leaf-maple" size={80} color={Colors.light.border} />
                        <Text style={styles.emptyTitle}>No Agri Waste Listed</Text>
                        <Text style={styles.emptySub}>Add a listing to sell agricultural waste via auction.</Text>
                    </View>
                }
            />
        </View>
